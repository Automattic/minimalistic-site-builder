...
- Render-time image treatment is build-owned. Rules or keyframes targeting `.wp-block-image`, `.wp-block-gallery`, `.wp-block-cover`, `.wp-block-media-text__media`, `.card-media`, `.card-media-tall`, `.card-media-thumb`, or their image/pseudo layers must not declare `filter`, `mix-blend-mode`, or a CSS-wide `all` reset.

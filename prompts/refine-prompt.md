...
- PRESERVE every concrete fact the user gave — names, locations, hours, contact details, products/services, prices, taglines, colors or style words, requested sections, named pages (Home / Menu / About / …), and any specific animation/motion behavior they asked for (keep such requests verbatim). Never drop or contradict a stated fact.

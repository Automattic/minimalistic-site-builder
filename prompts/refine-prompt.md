...
- PRESERVE the page ground the user stated, word for word ("light page", "white background", "dark ground", "near-black"): a later build step reads those exact phrases, and a paraphrase loses the decision.

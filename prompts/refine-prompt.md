...
Rewrite it into ONE clear, self-contained brief that the builder can turn into a great site. The site is a single landing page — one strong, scrollable home page, not a multi-page site — so describe everything that page should convey; do not imply separate pages or navigation to other destinations.
...
If the original prompt is already clear and detailed, return it essentially unchanged (light polish only).

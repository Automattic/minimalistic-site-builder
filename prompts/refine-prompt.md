...
- Clarify short or ambiguous requests into a buildable description of the site's purpose, audience, and offering. Preserve explicit aesthetic choices. When style is unspecified, leave it open for concept exploration; do not add an inferred palette, mood, era, typography, or design tradition. Any inferred content needs are suggestions, not user-stated facts.

...
- Keep accent focused on buttons/CTAs. Never use accent for body text or large-area backgrounds; preserve the primary action's hierarchy. Coordinate the section's palette and image choices with the design direction.

...
- Use the committed palette in proportions that express the requested style. Large chromatic fields are valid when the concept calls for them, including an accent-colored surface with readable contrasting text. Preserve the primary action's hierarchy through placement and construction, not a universal ban on color elsewhere.
...
- **Heading copy:** use concise, meaningful headings. Punctuation, including dashes and ranges, is allowed when it carries meaning. Avoid repetitive label-plus-slogan formulas and preserve both endpoints of any range.
...
Follow the **Style signature** through imagery, palette, typography and composition. Request relevant illustrations or artwork through the image subject and supported style, consistent with the shared image grade. Do not repeat decorative shapes as proof of style.

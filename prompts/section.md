...
Follow the **Style signature** through image choice, palette, typography, proportions and spacing. Generated illustrations and other artwork can carry the visual language where appropriate; specify them in the image subject and supported style field, consistent with the shared image grade. Do not attach a repeated decorative shape to every section as proof of style. Keep imagery relevant to the section's content.

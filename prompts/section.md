...
- CTA labels: reuse the exact visitor-facing label for the same intent across this section, the hero, and the header. "Get in touch" and "Let's talk" for the same destination fail.

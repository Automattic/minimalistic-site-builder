...
- HERO TEXT BUDGET — the hero's complete text stack is: an optional eyebrow (`caption`), the H1, ONE lead line, the buttons, and at most one microcopy line (`caption`) under them. Never two paragraphs, never a second reading-size block. If the brief hands you more facts than the budget holds, the extras belong to the next section, not the hero.

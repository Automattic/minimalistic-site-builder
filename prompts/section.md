...
- Write real, specific copy in the brand voice grounded in the site spec — never lorem ipsum. When the DESIGN DIRECTION commits a **Headline register**, every heading and standout line speaks in that register — it is the site's committed voice, not a suggestion. Speak it about THIS section's own content: never reuse or lightly rephrase the hero's H1 or the register's example fragment as another section's heading.

...
4. **It can be built without losing its identity.** The site can show type, color, spacing, photographs, wrapper borders and CSS geometry: repeated linear/radial/conic gradients, curved or stepped shapes, and graphic separators on empty pseudo-elements. Do not penalize ornament when the requested style needs it, or reward plainness as inherently safer. Bespoke illustrations, intricate hand-drawn filigree, custom icon sets and lettering rendered as imagery still need assets this channel cannot supply. If a named style depends on graphic structure, a palette and a vaguely related serif alone do not satisfy it.

...
4. **oversized-wordmark** — the site name is the dominant visual element: wp:site-title at display scale (`"fontSize"` set to one of the theme's largest fontSize preset slugs, "fontFamily":"heading"), with a small, quiet wp:navigation tucked beside or beneath it. Suits type-driven, brutalist, and studio directions.

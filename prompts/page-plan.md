...
{{footer_surface_rule}}
- Plan width rhythm within the compositions the content needs: constrained lead copy can sit inside a wider split, row, or grid, while image-led bands can run wide or full. Never choose an archetype merely to obtain a narrow beat . A centered text_placement moves the copy column; it does not change the archetype.

...
- Copy budget: one heading and one lead line for the band. Each row holds a
  heading and one short line. Use a short label only when it adds useful orientation.

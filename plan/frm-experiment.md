...
- 2026-09-05 turn 17: PR-2e #462 merged. PR-5e parked (font sidebearing, not markup). PR-5d built on branch `frm/emphasis-variety`: the heading_emphasis field ties italic-word to serif/didone/humanist/script traditions and playful or editorial concepts, highlight to friendly product and fintech on light grounds, two-tone to dark product, agency and portfolio sites in grotesque or geometric faces, and says two-tone is not the default.

...
- **Stop-condition note**: design-quality PRs open unreviewed (#228, #234) — #231 (BIGR-779) reviewed + merged to trunk (e89288f) 2026-08-07; the maintainer explicitly told the loop to keep going despite open PRs. Continue fix iterations; prefer replay evidence since cohort artifacts increasingly diverge from trunk.

...
## Current position
- **2026-08-07 (iter 12-13)**: Fix BIGR-792 ✓ — **PR #244 merged to trunk** (15903a3; no display-scale emails; portfolio4 rebuild clean, gist 281c8983ec553fd96c04cbee5270a1f2). Fix BIGR-793 ✓ — **PR #245 open** (filename-collision photo reuse; CollectImagesStep renames different-subject collisions; naturaleza4 replay with one generated variant image, gist e83c180c7a70c6966424f27f4fcc787d). PR count since directive: 8 (#237 #238 #240 #241 #242 #243 #244 #245).
...
- Reconciled 2026-08-07: #229 (BIGR-777), #230 (BIGR-778), #234 (BIGR-782), #235 (BIGR-784 caption half), #236 (BIGR-781), #237 (BIGR-783), #238 (BIGR-787), #240 (BIGR-788), #242 (BIGR-790), #243 (BIGR-791), #244 (BIGR-792) all MERGED. Open unreviewed: #228, #241, #245.

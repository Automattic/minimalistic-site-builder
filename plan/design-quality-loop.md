...
## Current position
- **2026-08-07 (iter 6)**: Fix BIGR-783 ✓ — **PR #237 open** (fix/bigr-783-pagewide-copy-dedupe). New deterministic copy-dedupe step after section-rhythm: label-styled paragraphs (exact or strict echo: >=3 shared tokens, >=0.8 containment, no supersets) + quote bodies (6-token shared opening); earliest wins, footer is read-only canon at the closing seam, sole-child removals widen to the emptied wrapper, planned sections anchor-only, cap 4/page. 1842/1842 tests. Cohort verification: only tbilisi triggers (its 2 real dups); 6/7 pages untouched. Evidence: tbilisi26/27 replay, gist ab570fe63d792b4d45c5cba0245f899f. **Maintainer directive 2026-08-07: keep looping until 10 more PRs are open (ignore the 3-open-PR stop condition).** PR count since directive: 1 (#237).
...
- Reconciled 2026-08-07: #229 (BIGR-777), #230 (BIGR-778), #234 (BIGR-782), #235 (BIGR-784 caption half), #236 (BIGR-781) all MERGED. Open unreviewed: #228, #237.

...
## Current position
- **2026-08-07 (iter 7)**: Fix BIGR-787 ✓ — **PR #238 open**. CollectImagesStep removes theme: asset references no placeholder declares (mangled AI_IMAGE markers); media removal extracted to shared MediaReferenceRemoval; image removal now takes an orphaned caption-styled sibling too. 1834/1834 tests. Evidence: hearth2 replay, gist 83e2c663b64f19cd22592daeef37a868. PR count since 10-PR directive: 2 (#237, #238).
...
- Reconciled 2026-08-07: #229 (BIGR-777), #230 (BIGR-778), #234 (BIGR-782), #235 (BIGR-784 caption half), #236 (BIGR-781), #237 (BIGR-783) all MERGED. Open unreviewed: #228, #238.

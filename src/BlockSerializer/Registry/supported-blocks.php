...
return [
    ...
    'core/tabs' => SaveStrategy::STATIC_RENDERER,
    'core/tab-list' => SaveStrategy::STATIC_RENDERER,
    'core/tab-panels' => SaveStrategy::STATIC_RENDERER,
    'core/tab-panel' => SaveStrategy::STATIC_RENDERER,

 ...
 * slugs are filled from the design direction's committed values, then
 * heading/body families and palette hexes that disagree with the direction
 * are written back. Every fill or overwrite is recorded in warnings.json —
 * a missing slug never aborts the build.
 *

 ...
 * direction's committed values, then heading/body families and palette hexes
 * that disagree with the direction are written back. When an accent family
 * ships, captions pick it up even if a section forgot fontFamily:accent.
 * Every fill or overwrite is recorded in warnings.json — a missing slug never
 * aborts the build.
 *

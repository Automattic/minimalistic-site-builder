 ...
 * item pattern, depth, canvas, measure, image grade, image crop, motion),
 * and a prose narrative that every downstream design and section prompt
 * receives verbatim as the authoritative brief.
 *

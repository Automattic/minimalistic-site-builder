...
**On the HTML-first default graph:** items 01–08 and 10 ship as catalogs
plus bind/repair (optional `type.accent`, `surface` + `device` kits,
theme.json hex/family bind, motion-note mapping, image-grade fight
strip, `direction-fidelity` after finalize). Item 09 restores
direction utilities (`device--*`, `card-style--*`, motion classes,
`u-*`, `has-accent-font-family`) after convert and warns when a
button is flattened.
...
[impeccable.md](impeccable.md) — what to take from
[pbakaus/impeccable](https://github.com/pbakaus/impeccable)
(Apache-2.0). Take: the larger unjustified-default face
cluster, three aesthetic-cluster rotations, scene-driven
light/dark, palette-tinted browser chrome (selection, caret,
scrollbar), 45–75ch prose, shadow = offset + blur. Do not
take their DESIGN.md ceremony, concept tournament, or
finish-reviewer loop.
...
- [impeccable SKILL.md](https://github.com/pbakaus/impeccable/blob/main/.agent/skills/impeccable/SKILL.md)
- [craft-floor.md](https://github.com/pbakaus/impeccable/blob/main/.agent/skills/impeccable/reference/craft-floor.md)

...
const SUPPORTED_BLOCKS = Object.freeze({
  ...
  // Entered the domain after the oracle was removed (619b8c9) and was
  // hand-certified as amendment b580c20. Declared here so the generator
  // derives its probes from the real runtime instead.
  'core/details': { strategy: 'STATIC_RENDERER', probes: [{ summary: 'Probe summary' }, { summary: 'Probe summary', showContent: true, name: 'probe-group' }] },

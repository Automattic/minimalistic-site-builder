...
test('normalizeGroupBlockPadding removes recursive vertical defaults and preserves siblings', function () {
    ...
    $normalized = ThemeJsonStep::normalizeGroupBlockPadding($theme);
    ...
    $scalar = ThemeJsonStep::normalizeGroupBlockPadding(['styles' => ['blocks' => [
    ...
    assert_eq($missing, ThemeJsonStep::normalizeGroupBlockPadding($missing), 'missing path untouched');
});

...
test('the wordmark-stage recipe sets the site name giant as the one headline, with an optional facts ledger (frm W2e)', function () {
    ...
    assert_eq(5.24, HeroComposition::wordmarkEm('Das Studio'), 'per-character advances of a bold grotesque (frm PR-2v)');
    assert_eq(3.08, HeroComposition::wordmarkEm('Studio'));
    assert_eq(5.53, HeroComposition::wordmarkEm('momentum'), 'wide m and u letters count');
